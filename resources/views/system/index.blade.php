<x-app-layout>
    ...
    <div class="px-0 sm:px-2 space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <!-- Backup Card -->
            <div class="bg-white rounded-[2rem] p-8 shadow-sm border border-slate-100 hover:bg-blue-50/30 hover:border-blue-200 hover:shadow-xl hover:shadow-blue-600/5 transition-all duration-500 group"
                 x-data="{ confirmBackup: false }">
                <div class="flex items-start justify-between mb-6">
                    <div class="h-14 w-14 rounded-2xl bg-blue-50 flex items-center justify-center text-blue-500 group-hover:scale-110 group-hover:bg-blue-600 group-hover:text-white transition-all duration-500 shadow-sm border border-blue-100">
                    ...
                    <span class="px-4 py-1.5 rounded-full bg-blue-100 text-blue-700 text-[10px] font-black uppercase tracking-widest border border-blue-200 shadow-sm">Database Safe</span>
                </div>
                <h4 class="text-xl font-black text-slate-800 mb-2">Backup Database</h4>
                <p class="text-sm text-slate-500 leading-relaxed mb-8">Download cadangan data sistem (.sql) secara instan untuk keamanan data Anda.</p>
                ...
                <template x-teleport="body">
                    <div x-show="confirmBackup" class="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6" x-cloak>
                        ...
                        <div class="relative bg-white rounded-[2.5rem] shadow-2xl w-full max-w-sm p-8 text-center border border-slate-100" x-show="confirmBackup" x-transition:scale>
                            ...
                            <p class="text-sm text-slate-500 mb-8">Database akan diproses dan langsung diunduh ke perangkat Anda.</p>
            ...
            <!-- Reset Data Card -->
            <div class="bg-white rounded-[2rem] p-8 shadow-sm border border-slate-100 hover:bg-rose-50/30 hover:border-rose-200 hover:shadow-xl hover:shadow-rose-600/5 transition-all duration-500 group"
                 x-data="{ open: false, confirmation: '', loading: false }">
                <div class="flex items-start justify-between mb-6">
                    <div class="h-14 w-14 rounded-2xl bg-rose-50 flex items-center justify-center text-rose-500 group-hover:scale-110 group-hover:bg-rose-600 group-hover:text-white transition-all duration-500 shadow-sm border border-rose-100">
                    ...
                    <span class="px-4 py-1.5 rounded-full bg-rose-100 text-rose-700 text-[10px] font-black uppercase tracking-widest border border-rose-200 shadow-sm">Danger Zone</span>
                </div>
                <h3 class="text-xl font-black text-slate-800 mb-2">Reset Data Request</h3>
                <p class="text-sm text-slate-500 leading-relaxed mb-8">Hapus seluruh riwayat permintaan barang secara permanen dari database.</p>
                            ...
                            <form action="{{ route('system.reset-requests') }}" method="POST" x-ref="resetForm" @submit="loading = true">
                                ...
                                <div class="p-8">
                                    <div class="text-center mb-6">
                                        ...
                                        <h3 class="text-2xl font-black text-slate-800 mb-2">Konfirmasi Reset</h3>
                                        <p class="text-sm text-slate-500">Tindakan ini permanen. Ketik <span class="text-rose-600 font-bold underline">RESET</span> untuk melanjutkan.</p>
                                    </div>
