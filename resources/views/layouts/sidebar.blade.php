<aside id="sidebar" 
    ...
    <div class="flex flex-col flex-1 overflow-y-auto mt-4 min-h-0 custom-scrollbar">
        <nav class="flex-1 py-4 space-y-1">
            ...
            <a href="{{ route('system.index') }}" class="flex items-center px-6 py-3 text-sm font-medium transition-all duration-200 active:scale-95 transform {{ request()->routeIs('system.*') ? 'bg-white/10 text-white border-l-4 border-emerald-400 shadow-inner' : 'text-slate-300 hover:bg-white/5 hover:text-white hover:-translate-y-0.5' }}">
